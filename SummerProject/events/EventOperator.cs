...
namespace SummerProject
{
    public class EventOperator
    {
        ...
        public EventOperator(SpriteFont font, Game1 game, Texture2D upgradeViewText, GameMode gameMode, AchievementController achControl, Player player, List<IDs> upgradePartsIDs)
        {            
            GameState = MENU_STATE;
            NewGameState = GameState;
            GameMode = gameMode;
            animatedHandler = new AnimatedEventHandler(game, this, font);
            upgradeView = new UpgradeView(upgradeViewText, font, player, upgradePartsIDs);            
